"""
This file contains the class Pipeline_structure, 
which is used to train and test the hyper-KalmanNet model with CM layers generated by structured Hypernets.
